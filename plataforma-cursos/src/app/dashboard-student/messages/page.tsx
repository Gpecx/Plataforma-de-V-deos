...
// Mock data — wire up to Supabase as needed
            ...
            <div className="max-w-6xl mx-auto p-8 md:p-12">
                ...
                <div className="mb-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
                    ...
                    <Link
                        ...
                        className="flex items-center gap-2 text-xs font-black uppercase tracking-widest text-gray-500 hover:text-white transition border border-white/5 bg-white/5 px-5 py-3 rounded-xl"
                    >
                        <ArrowLeft size={16} />
                        Voltar
                    </Link>
                        ...
                        {selected ? (
                            <div className="bg-white/5 border border-white/10 rounded-[32px] p-8 animate-in fade-in slide-in-from-right-2 duration-300">
                                ...
                                <div className="flex items-start gap-5 mb-8 pb-8 border-b border-white/5">
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="mt-3 inline-flex items-center gap-2 px-3 py-1 bg-white/5 rounded-lg border border-white/5 text-[8px] font-black uppercase tracking-widest text-gray-500 italic">
                                            Re: {selected.lesson}
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div className="bg-black/20 rounded-2xl p-6 mb-8">
                                    <p className="text-sm text-gray-300 leading-relaxed font-medium italic">"{selected.fullText}"</p>
                                </div>
                            ...
                            <div className="h-full flex items-center justify-center py-24 bg-white/[0.02] border border-white/5 rounded-[32px]">
                                <div className="text-center">
                                    ...
                                    <p className="text-xs font-black uppercase tracking-widest text-gray-600 italic">Selecione uma mensagem</p>
                                </div>
                            </div>
                        )}
                    </div>
