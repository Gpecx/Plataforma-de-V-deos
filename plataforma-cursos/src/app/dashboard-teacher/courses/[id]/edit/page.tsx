...
import { uploadCourseVideo, uploadCourseImage } from '@/utils/supabase/storage'
            ...
            {isUploading && (
                <div className="bg-slate-900 border border-slate-800 p-8 rounded-[32px] flex items-center gap-6 shadow-2xl animate-pulse">
                    ...
                    <div>
                        ...
                        <span className="text-[9px] text-slate-500 font-bold uppercase tracking-widest">Sincronizando com Servidores Supabase...</span>
                    </div>
                </div>
            )}
        </div>
...
export default function CourseBuilder() {
    ...
    useEffect(() => {
        async function fetchCourseData() {
            ...
            // Por enquanto, colocamos tudo em um único módulo fixo pois a tabela lessons é plana
            setModules([
                {
                    id: 'main-structure',
