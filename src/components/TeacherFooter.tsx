...
export default function TeacherFooter() {
    return (
        <footer className="relative pt-24 pb-20 overflow-hidden font-montserrat z-[10]" style={{ backgroundColor: 'transparent' }}>
            <div className="max-w-7xl mx-auto px-8 md:px-12 relative z-10 flex flex-col items-center space-y-12">
                ...
                <div className="flex flex-wrap justify-center gap-x-12 gap-y-8">
                    <Link href="/dashboard-teacher" className="flex flex-col items-center gap-2 group">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#061629] group-hover:text-[#1D5F31]">Dashboard</span>
                    </Link>

                    <Link href="/dashboard-teacher/courses" className="flex flex-col items-center gap-2 group">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#061629] group-hover:text-[#1D5F31]">Meus Cursos</span>
                    </Link>

                    <Link href="/dashboard-teacher/students" className="flex flex-col items-center gap-2 group">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#061629] group-hover:text-[#1D5F31]">Alunos</span>
                    </Link>

                    <Link href="/dashboard-teacher/chat" className="flex flex-col items-center gap-2 group">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#061629] group-hover:text-[#1D5F31]">Mensagens</span>
                    </Link>

                    <Link href="/dashboard-teacher/analytics" className="flex flex-col items-center gap-2 group">
                        <span className="text-[10px] font-bold uppercase tracking-widest text-[#061629] group-hover:text-[#1D5F31]">Financeiro</span>
                    </Link>
                </div>

                {/* Copyright Sutil */}
                <div className="pt-8 w-full text-center">
                    <p className="text-[#061629]/50 text-[9px] font-bold uppercase tracking-[0.4em]">
