                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
                    ...
                    <div className="flex flex-col space-y-6">
                        <Logo 
                            ...
                            light={!isDark} 
                        />
                        <p className={`text-sm leading-relaxed max-w-xs ${isDark ? 'text-white/60' : 'text-slate-600'}`}>
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="flex flex-col space-y-4">
                            <div className="flex items-start gap-3 group">
                                <div className={`mt-1 p-1.5 rounded-lg transition-colors ${isDark ? 'bg-white/5 text-white/40 group-hover:bg-[#1D5F31]/20 group-hover:text-[#1D5F31]' : 'bg-slate-50 text-slate-400 group-hover:bg-slate-100 group-hover:text-[#1D5F31]'}`}>
                                    <Mail size={16} />
                                </div>
                                <a href="mailto:comercial@voltsmind.com.br" className={`text-sm transition-colors ${isDark ? 'text-white/60 hover:text-white' : 'text-slate-600 hover:text-[#1D5F31]'}`}>
                            ...
                            <div className="flex items-start gap-3 group">
                                ...
                                <a href="tel:19971290901" className={`text-sm transition-colors ${isDark ? 'text-white/60 hover:text-white' : 'text-slate-600 hover:text-[#1D5F31]'}`}>
                                    19 97129-0901
                                </a>
                            </div>
                            <div className="flex items-start gap-3 group">
                                ...
                                <span className={`text-sm leading-relaxed ${isDark ? 'text-white/60' : 'text-slate-600'}`}>
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div className="flex flex-col space-y-3">
                            <Link href="/termos" className={`text-sm transition-colors ${isDark ? 'text-white/60 hover:text-[#1D5F31]' : 'text-slate-600 hover:text-[#1D5F31]'}`}>
                                Termos de Uso
                            </Link>
                            <Link href="/privacidade" className={`text-sm transition-colors ${isDark ? 'text-white/60 hover:text-[#1D5F31]' : 'text-slate-600 hover:text-[#1D5F31]'}`}>
