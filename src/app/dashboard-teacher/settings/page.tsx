...
export default function TeacherSettingsPage() {
    ...
    return (
        <div className="min-h-screen bg-[#F4F7F9] p-8 md:p-12 space-y-16 font-exo border-t border-slate-100 pb-32">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 max-w-6xl mx-auto">
                        ...
                        {needsReauth && (
                            <div className="max-w-md space-y-3 animate-in fade-in slide-in-from-top-2">
                                ...
                                <Input
                                    ...
                                    className="bg-[#00C402]/5 border-[#00C402]/20 h-14 rounded-2xl text-slate-900 focus:border-[#00C402] font-bold text-sm"
                                    required
                                />
                            </div>
                        )}
                        ...
                        <div className="flex flex-col md:flex-row gap-8">
                            ...
                            <div className="flex items-end">
                                <Button
                                    ...
                                    variant="outline"
                                    className="border-slate-100 text-slate-400 hover:bg-slate-50 hover:text-slate-900 h-14 px-8 rounded-2xl font-black uppercase tracking-[2px] text-[10px] transition-all gap-2"
                                >
                                    {isUpdatingPassword ? (
                                        <div className="w-4 h-4 border-2 border-slate-200 border-t-[#00C402] rounded-full animate-spin" />
                                    ) : (
                                        <Save size={16} />
                                    )}
                ...
                {/* Zona de Perigo (Mirror Student) */}
                <section className="bg-red-50 border border-red-100 rounded-[32px] p-10 shadow-sm space-y-8 lg:col-span-2">
                    <div className="flex items-center gap-4">
                        <div className="p-4 bg-white border border-red-100 rounded-2xl text-red-500 shadow-sm">
                    ...
                    <p className="text-[11px] text-red-600/70 max-w-2xl font-bold uppercase tracking-wider leading-relaxed bg-white/50 p-6 rounded-2xl border border-red-100/50">
