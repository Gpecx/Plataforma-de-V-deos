...
const MOCK_COMMENTS: Comment[] = [
    {
        id: '1',
        user: 'Gabriel Mendes',
        course: 'Engenharia de Software EXS',
    ...
    return (
        <div className="p-8 md:p-12 min-h-screen bg-[#061629] text-white font-exo">
            <header className="mb-12">
                ...
                <p className="text-gray-400 mt-2 font-medium uppercase text-xs tracking-widest">Responda seus alunos com agilidade e mantenha a qualidade EXS.</p>
            </header>
