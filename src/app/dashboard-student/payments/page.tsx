        ...
        <div className="p-8 md:p-12 min-h-screen font-exo text-white bg-[#0d2b17] animate-in fade-in duration-500">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-[#0f1f14] border-2 border-[#1e4d2b] p-8 md:p-10 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-10">
                            <h2 className="text-lg font-black uppercase tracking-tighter text-white">Histórico de Transações</h2>
                            <button className="text-[10px] font-black uppercase tracking-widest text-[#00C402] hover:text-white transition-colors">
                                Exportar PDF
                            </button>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b-2 border-[#1e4d2b] uppercase text-[9px] font-black text-slate-400 tracking-[2px]">
                                ...
                                <tbody className="divide-y divide-[#1e4d2b]">
                                    {TRANSACTIONS.map((t) => (
                                        <tr key={t.id} className="group hover:bg-[#1e4d2b]/20 transition-colors">
                                            ...
                                            <td className="py-6">
                                                <div className="flex items-center gap-3">
                                                    <t.icon size={14} className="text-[#00C402]" />
                ...
                <div className="space-y-8">
                    <div className="bg-[#0f1f14] border-2 border-[#1e4d2b] p-10 text-white relative overflow-hidden group">
                        <div className="relative z-10">
                            ...
                            <div className="mb-12">
                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className="w-12 h-8 bg-[#1e4d2b] flex items-center justify-center">
                            ...
                            <button
                                ...
                                className="w-full h-14 border-2 border-[#1e4d2b] flex items-center justify-center gap-3 text-[10px] font-black uppercase tracking-widest hover:border-[#00C402] hover:text-[#00C402] transition-all"
                            >
                    ...
                    <div className="bg-[#0f1f14] border-2 border-[#1e4d2b] p-8">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="w-10 h-10 bg-[#1e4d2b] flex items-center justify-center text-[#00C402]">
                                <Calendar size={20} />
                            </div>
                            <div>
            ...
            {isModalOpen && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[#0d2b17]/90 backdrop-blur-sm">
                    <div className="bg-[#0f1f14] border-2 border-[#1e4d2b] w-full max-w-lg p-10 relative">
                        <button
                        ...
                        <div className="mb-10">
                            <div className="flex items-center gap-2 mb-2">
                                <div className="w-8 h-1 bg-[#00C402]"></div>
                        ...
                        <form onSubmit={handleSaveCard} className="space-y-6">
                            <div className="space-y-2">
                                ...
                                <input type="text" className="w-full h-16 bg-[#0d2b17] border-2 border-[#1e4d2b] px-6 text-sm font-bold tracking-[2px] text-white outline-none focus:border-[#00C402]" required />
                            </div>
                            {/* Repita o padrão de border-2 e bg-[#0d2b17] nos outros inputs */}
                            {/* ... */}
                        </form>
                    </div>
                </div>
