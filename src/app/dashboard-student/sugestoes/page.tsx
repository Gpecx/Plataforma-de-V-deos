...
export default function SugestoesPage() {
    ...
    return (
        <div className="min-h-screen bg-transparent font-exo text-white p-6 md:p-12">
            ...
            <div className="max-w-5xl mx-auto mt-10">
                ...
                <div className="bg-[#061629] border-2 border-[#1D5F31] overflow-hidden">
                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-[#061629] border-2 border-[#1D5F31] text-white placeholder:text-slate-700 rounded-none p-10 text-sm font-bold uppercase tracking-widest focus:outline-none focus:border-[#1D5F31] transition-all resize-none min-h-[300px]"
                                    />
                                </div>
                                ...
                                <button
                                    type="submit"
                                    className="w-full h-20 bg-[#1D5F31] hover:bg-[#00e602] text-white font-black uppercase tracking-[4px] rounded-none transition-all flex items-center justify-center gap-4 active:scale-[0.99] py-6 shadow-lg shadow-[#1D5F31]/10"
                                >
