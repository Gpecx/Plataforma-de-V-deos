        ...
        <div className="space-y-12 animate-in fade-in duration-700 font-exo p-8 md:p-12">
            <header>
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="text-[10px] font-black uppercase tracking-[5px] text-slate-600">CONTROL CENTER</span>
                </div>
                ...
                <p className="text-slate-600 mt-3 text-[10px] font-bold uppercase tracking-[3px] italic">Monitoramento global de receitas e transações da plataforma.</p>
            </header>
                ...
                {metrics.map((m, i) => (
                    <div key={i} className="bg-white p-10 rounded-[32px] border border-slate-200 hover:border-[#1D5F31]/30 transition-all group shadow-sm hover:shadow-xl">
                        <div className="flex justify-between items-start mb-8">
                            ...
                            <span className="text-[8px] font-black text-slate-300 uppercase tracking-widest whitespace-nowrap">REAL-TIME DATA</span>
                        </div>
                        <p className="text-slate-600 text-[10px] font-black uppercase tracking-[2px] mb-2">{m.label}</p>
                    ...
                    <div className="bg-white p-12 rounded-[40px] border border-slate-200 h-full flex flex-col shadow-sm">
                        <div className="flex items-center justify-between mb-12">
                            ...
                            <div className="flex items-center gap-4 bg-slate-50 px-5 py-2 rounded-xl border border-slate-100">
                                ...
                                <span className="text-[10px] font-black text-slate-600 uppercase tracking-widest">{data.payments.length} Transações</span>
                            </div>
                        </div>
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-left">
                                <thead>
                                    <tr className="border-b border-slate-50 text-[10px] font-black text-slate-600 uppercase tracking-[2px]">
                    ...
                    <div className="bg-white p-12 rounded-[40px] border border-slate-200 shadow-sm">
                        ...
                        <div className="mt-10 space-y-6">
                            <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest bg-slate-50 p-4 rounded-xl border border-slate-100">
                                <span className="text-slate-600">Taxa Plataforma</span>
                                <span className="text-[#1D5F31]">{data.platformTaxPercent}%</span>
                            </div>
                            <div className="flex items-center justify-between text-[10px] font-black uppercase tracking-widest bg-slate-50 p-4 rounded-xl border border-slate-100">
                                <span className="text-slate-600">Repasse Professor</span>
