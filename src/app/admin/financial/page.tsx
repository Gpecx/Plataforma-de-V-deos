                ...
                <div className="xl:col-span-8 lg:col-span-12 space-y-8 min-h-[600px]">
                    <div className="flex items-center justify-between mb-6 bg-white p-8 rounded-md border border-black/20 shadow-sm">
                        <div className="flex items-center gap-4">
                            <div className="w-12 h-12 rounded-xl bg-slate-50 flex items-center justify-center border border-black/20">
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="space-y-3">
                                            {plan.features.map((feat, fIdx) => (
                                                <div key={fIdx} className="flex gap-3 group/feature">
                                                    <Input
                                                        ...
                                                        className="bg-slate-50 border border-black/20 rounded-xl h-12 text-[11px] !text-[#000000] font-bold focus:bg-white focus:border-[#000000]/20 transition-all"
                                                        placeholder="Vantagem técnica..."
                                                    />
                                                    <Button variant="ghost" size="icon" onClick={() => removeFeature(pIdx, fIdx)} className="h-12 w-12 !text-[#000000] font-bold hover:text-rose-600 hover:bg-rose-50 transition-all rounded-xl active:scale-75">
                                                        <Trash2 size={14} />
                                                    </Button>
                                                </div>
                                            ))}
                                            <Button
                                                ...
                                                className="w-full border-2 border-dashed border-black/20 !text-[#000000] hover:bg-[#000000]/5 hover:border-[#000000]/20 text-[10px] font-bold uppercase tracking-wider h-12 rounded-xl transition-all"
                                            >
                                                + Adicionar Recurso
                                            </Button>
                                        </div>
