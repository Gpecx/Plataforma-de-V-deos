...
export default async function ApprovalsPage() {
    ...
    return (
        <div className="flex flex-col animate-in fadeIn duration-700 font-exo bg-white min-h-screen">
            ...
            <header className="w-full pt-12 pb-10 px-6 border-b border-slate-100">
                <div className="max-w-6xl mx-auto flex flex-col items-start text-left">
                    ...
                    <h1 className="text-4xl md:text-5xl font-[900] tracking-tighter uppercase italic leading-none text-slate-950">
