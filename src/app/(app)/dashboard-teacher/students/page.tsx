...
export default async function StudentsPage() {
    ...
    return (
        <div className="p-8 md:p-12 space-y-12 bg-transparent min-h-screen font-montserrat animate-in fade-in duration-500">
            ...
            <div className="bg-white border border-black/20 rounded-[32px] p-8 shadow-xl overflow-hidden relative">
                <div className="overflow-x-auto">
                    <table className="w-full text-left border-collapse">
                        <thead>
                            <tr className="border-b border-slate-100 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-600">
                                    ...
                                    <tr key={student.id} className="border-b border-slate-50 hover:bg-slate-50 transition-all group">
                                        <td className="py-6 px-4">
                                            <div className="flex items-center gap-4">
                                                <div className="w-10 h-10 rounded-full bg-white flex items-center justify-center font-bold text-black border border-black shadow-md uppercase text-xs">
                                                    {(student.profiles?.full_name || 'S').charAt(0)}
                                                </div>
                                                <div className="flex flex-col">
                                                    <span className="font-bold text-slate-900 text-sm tracking-tight uppercase group-hover:text-[#1D5F31] transition-colors">{student.profiles?.full_name}</span>
                                        ...
                                        <td className="py-6 px-4 text-center">
                                            <span className="px-3 py-1.5 bg-white rounded-lg text-[9px] font-bold border border-black text-slate-900 tracking-[1px] uppercase shadow-sm">
...
function NoStudents() {
    return (
        <div className="p-8 md:p-12 space-y-12 bg-transparent min-h-screen text-slate-900 font-montserrat animate-in fade-in duration-500">
            <header>
                <div className="flex items-center gap-3 mb-2">
                    <div className="w-1.5 h-1.5 rounded-full bg-[#1D5F31]"></div>
                    <span className="text-[10px] font-bold uppercase tracking-[4px] text-slate-500">VACANT STUDIO</span>
                </div>
                <h1 className="text-2xl md:text-3xl font-bold tracking-tighter text-slate-900 uppercase max-w-xl">
                    Gestão de <span className="text-[#1D5F31]">Alunos</span>
                </h1>
            </header>
            <div className="bg-white border border-slate-200 rounded-[40px] p-24 text-center shadow-xl">
                ...
                <h3 className="text-xl font-bold uppercase tracking-tighter text-slate-900 mb-2">Sua base de alunos está vazia</h3>
                <p className="text-slate-600 font-bold uppercase tracking-[3px] text-[10px] ">
                    Publique seu primeiro curso para começar a atrair talentos.
                </p>
                <Link href="/dashboard-teacher/courses/new" className="inline-block mt-10 bg-[#1D5F31] text-white px-10 py-5 rounded-2xl font-bold uppercase tracking-widest text-xs shadow-xl shadow-[#1D5F31]/10 hover:opacity-90 transition active:scale-95">
