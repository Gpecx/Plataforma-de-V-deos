  ...
  return (
    <div className="flex-1 flex items-center justify-center p-8 bg-[#020617] min-h-[500px] border-l border-white/5">
      <div className="max-w-md w-full text-center animate-in zoom-in-95 duration-500">
        ...
        <h2 className="text-2xl font-bold  uppercase tracking-tighter text-white mb-4">
        ...
        <div className="flex flex-col gap-4">
          <button
            onClick={() => reset()}
            className="group w-full flex items-center justify-center gap-3 px-8 py-5 bg-[#1D5F31] text-white font-bold uppercase tracking-widest text-xs hover:bg-[#28b828] transition-all shadow-xl transform active:scale-95"
          >
          ...
          <div className="py-4 border-t border-white/5 mt-4">
            ...
            <div className="flex items-center justify-center gap-2 text-amber-500/60 font-bold text-xs uppercase tracking-widest ">
