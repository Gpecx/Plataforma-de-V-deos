                ...
                <div className="lg:col-span-2 space-y-8">
                    <div className="bg-white border border-black rounded-xl shadow-sm p-8 md:p-10 relative overflow-hidden">
                        <div className="flex items-center justify-between mb-10">
                            ...
                            <button className="text-[10px] font-bold uppercase tracking-widest text-gray-700 hover:text-gray-900 border border-black hover:border-black hover:bg-gray-50 px-4 py-2 rounded-xl transition-all shadow-sm">
                                Exportar PDF
                            </button>
                        </div>
