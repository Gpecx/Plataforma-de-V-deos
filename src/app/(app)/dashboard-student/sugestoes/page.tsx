                            ...
                            <form onSubmit={handleSubmit} className="space-y-8">
                                <div className="space-y-4">
                                    ...
                                    <textarea
                                        ...
                                        className="w-full bg-[#061629] border-2 border-[#1D5F31] text-white placeholder:text-slate-700 rounded-xl p-10 text-sm font-bold uppercase tracking-widest focus:outline-none focus:border-[#1D5F31] transition-all resize-none min-h-[300px]"
                                    />
                                </div>
