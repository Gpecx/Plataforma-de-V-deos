...
export default function CertificatesPage() {
    return (
        <div className="p-8 md:p-12 min-h-screen font-exo text-black bg-transparent animate-in fade-in duration-500">
            <header className="mb-12">
                <div className="flex items-center gap-3 mb-2">
                    <span className="text-[10px] font-black uppercase tracking-[5px] text-[#1D5F31]">CONQUISTAS</span>
                </div>
                <h1 className="text-4xl font-black tracking-tighter text-[#061629] uppercase">
            ...
            <div className="w-full">
                ...
                <div className="bg-white border border-black py-24 md:py-32 flex flex-col items-center text-center relative overflow-hidden rounded-3xl">
                    ...
                    <div className="relative z-10">
                        ...
                        <h2 className="text-2xl font-black uppercase tracking-tighter text-[#061629] mb-4">
                        ...
                        <div className="mt-12 flex flex-col md:flex-row items-center justify-center gap-4">
                            <div className="flex items-center gap-2 text-[9px] font-black uppercase tracking-[3px] text-slate-900 bg-white px-6 py-4 border border-black rounded-xl shadow-sm">
