        ...
        <div className="mt-4 transition-colors duration-500">
            ...
            <div className="flex gap-8 mb-8 transition-colors duration-500">
                <button
                    ...
                    className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all relative ${activeTab === 'overview' ? 'text-[#1D5F31]' : isDark ? 'text-gray-600 hover:text-slate-300' : 'text-white/40 hover:text-white'}`}
                >
                    Visão Geral
                    {activeTab === 'overview' && (
                ...
                <button
                    ...
                    className={`pb-4 text-sm font-bold uppercase tracking-widest transition-all relative ${activeTab === 'comments' ? 'text-[#1D5F31]' : isDark ? 'text-gray-600 hover:text-slate-300' : 'text-white/40 hover:text-white'}`}
                >
                    Comentários (Q&A)
                    {activeTab === 'comments' && (
                        <div className="absolute bottom-0 left-0 right-0 h-0.5 bg-[#1D5F31] shadow-[0_0_10px_rgba(50,205,50,0.5)]"></div>
            ...
            <div className="animate-in fade-in slide-in-from-bottom-2 duration-500">
                {activeTab === 'overview' ? (
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="space-y-3">
                                <a href="#" className={`flex items-center justify-between p-4 border rounded-none hover:border-[#1D5F31]/30 transition-all group ${isDark ? 'bg-white/5 border-white/5' : 'bg-white/5 border-white/10'}`}>
                                    <div className="flex items-center gap-3">
                                        <div className={`p-2 rounded-none transition-colors ${isDark ? 'bg-white/5 text-gray-400 group-hover:text-[#1D5F31]' : 'bg-white/5 text-white/40 group-hover:text-[#1D5F31]'}`}>
                                            <FileText size={18} />
                                        </div>
                                        <div>
                                    ...
                                    <Download size={18} className="text-white/40 group-hover:text-[#1D5F31]" />
                                </a>
                                <a href="#" className={`flex items-center justify-between p-4 border rounded-none hover:border-[#1D5F31]/30 transition-all group ${isDark ? 'bg-white/5 border-white/5' : 'bg-white/5 border-white/10'}`}>
                                    <div className="flex items-center gap-3">
                                        <div className={`p-2 rounded-none transition-colors ${isDark ? 'bg-white/5 text-gray-400 group-hover:text-[#1D5F31]' : 'bg-white/5 text-white/40 group-hover:text-[#1D5F31]'}`}>
                    ...
                    <div className="max-w-4xl space-y-8">
                        <div className={`flex gap-4 p-6 rounded-none border transition-all ${isDark ? 'bg-white/5 border-white/10 focus-within:border-[#1D5F31]/30' : 'bg-white/5 border-white/10 focus-within:border-[#1D5F31]/50 shadow-sm'}`}>
                            ...
                            <div className="flex-1 space-y-4">
                                ...
                                <div className="flex justify-end">
                                    <button className="px-6 py-2 bg-[#1D5F31] text-white text-xs font-black uppercase italic rounded-none hover:scale-105 transition-all">
                                        Enviar Pergunta
                                    </button>
                                </div>
                            </div>
                        ...
                        <div className="space-y-8 pb-20">
                            {MOCK_COMMENTS.map((comment) => (
                                <div key={comment.id} className="space-y-4">
                                    <div className={`p-6 rounded-none border transition-all ${comment.isInstructor ? 'bg-[#1D5F31]/5 border-[#1D5F31]/20' : isDark ? 'bg-white/5 border-white/5' : 'bg-white/5 border-white/10 shadow-sm'}`}>
                                                ...
                                                <div>
                                                    <div className="flex items-center gap-2">
                                                        ...
                                                        {comment.isInstructor && (
                                                            <span className="flex items-center gap-1 px-2 py-0.5 bg-[#1D5F31] text-white text-[8px] font-black uppercase rounded tracking-widest">
                                                                <CheckCircle2 size={8} />
                                                                Instrutor
                                                            </span>
                                                        )}
