            ...
            <div className="min-h-screen bg-white text-black font-montserrat py-20 px-4">
                <div className="max-w-3xl mx-auto text-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center">
                        ...
                        <Link
                            href="/course"
                            className="px-10 py-5 bg-[#1D5F31] !text-white font-bold uppercase tracking-[3px] hover:bg-[#1D5F31]/90 transition-all text-sm rounded-none"
                        >
                            CONTINUAR COMPRANDO
                        </Link>
                    </div>

                    <p className="mt-12 text-black text-xs font-bold uppercase tracking-[2px] not-italic">
